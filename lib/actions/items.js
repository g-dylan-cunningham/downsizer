 ...
 * Exports: createItem, getItems, getItem, deleteItem, bulkDeleteItems
 * Invariants:
 ...
 * - Deleting an item cascades to delete associated images.
 */
...
/**
 * Deletes an item and its associated images.
 * Validates project ownership.
 * @param {string} projectId - Project UUID
 * @param {string} itemId - Item UUID
...
export async function deleteItem(projectId, itemId) {
  ...
  try {
    ...
    // Delete item (cascade will delete images and move events)
...
/**
 * Deletes multiple items and their associated images.
 * Validates project ownership.
 * @param {string} projectId - Project UUID
 * @param {string[]} itemIds - Array of Item UUIDs
 * @returns {Promise<{success: boolean, deleted?: number, error?: string}>}
 */
export async function bulkDeleteItems(projectId, itemIds) {
  const { user, error: authError } = await getUser();
  ...
  try {
    ...
    // Delete items (cascade will delete images and move events)
    // Only delete items that belong to this project
