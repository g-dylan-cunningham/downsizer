/**
 * Purpose: Group item capture page.
 * Exports: default GroupCapturePage component.
 * Invariants:
 * - Creates items with kind=group, count>=2 (user-entered).
...
export default async function GroupCapturePage({ params, searchParams }) {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
          For multiple similar items like utensils, books, or mugs
        </p>
      </div>
